      ...
      <DialogContent className="border-white/10 bg-[#0a0a0a] w-[90%] md:w-full sm:max-w-lg p-6 md:p-16 rounded-2xl">
        ...
        <div className="mt-12">
          <button
            ...
            disabled={isLoading}
            className="group relative flex w-full items-center justify-center gap-4 overflow-hidden rounded-full border border-white/10 bg-white/5 px-10 py-5 transition-all hover:bg-white hover:text-black disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:bg-white/5 disabled:hover:text-current"
          >
            {isLoading ? (
